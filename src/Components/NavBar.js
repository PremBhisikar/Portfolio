...
import { TwitterIcon, DribbbleIcon, GithubIcon, PinterestIcon, SunIcon, LinkedInIcon, MoonIcon } from './Icons'
        ...
        '>
           ...
           <nav>
            ...
            <nav className='flex items-center justify-center flex-wrap '>
                <motion.a href="https://twitter.com/prembhisikar1" target={'_blank'}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mr-3'
                >
                ...
                <motion.a href="https://github.com/PremBhisikar" target={'_blank'}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mx-3'
                >
                ...
                <motion.a href="www.linkedin.com/in/prem-bhisikar" target={'_blank'}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mx-3'
                >
